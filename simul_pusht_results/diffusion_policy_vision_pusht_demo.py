...
num_epochs = 100
filename = "pusht_state_100ep_diffusion.ckpt"
retrain = False
...
for num_diffusion_iters_eval in num_diffusion_iters_ls:
    ...
    with tqdm(total=max_steps, desc="Eval PushTImageEnv") as pbar:
        while not done:
            ...
            with torch.no_grad():
                ...
                # init scheduler
                noise_scheduler.set_timesteps(num_diffusion_iters_eval)
    ...
    # visualize
    vwrite(os.path.join(master_dir, f'vis_diffusion_{num_diffusion_iters_eval}.mp4'), imgs)
print(scores)
